...
\begin{center}
    ...
    \captionof{figure}{Do you notice how Nmap is sending the SYN packets to port 80? Twice? For each IP in the specified subnet.}
    \end{center}
...
\begin{center}
    ...
    \begin{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Do you notice how Nmap is sending the UDP packets to uncommon ports multiple times for each IP address in the specified subnet?}
            \end{center}
\end{document} 