...
\usepackage{lmodern}           
\usepackage[paperwidth=330mm,paperheight=450mm,margin=0.3in]{geometry}  % Further reduced margins to 0.3in
\usepackage{xcolor}            
\usepackage{colortbl}       
\usepackage{hyperref}      
\usepackage{graphicx}     
...
\subsection{\huge Aggressive Scan (-A)}

{\LARGE What if you can have both \textbf{-O}, \textbf{-sV} and some more in one option? That would be \textbf{-A}. This option enables OS detection, version scanning, and traceroute, among other things.}
