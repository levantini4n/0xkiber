...
\subsection{\Large Aggressive Scan (-A)}

What if you can have both \textbf{-O}, \textbf{-sV} and some more in one option? That would be \textbf{-A}. This option enables OS detection, version scanning, and traceroute, among other things.
